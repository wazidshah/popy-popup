		...
		<div class="wrap popy-wrap">
			...
			<div class="popy-header">
				<div class="popy-header-inner">
					...
					<div>
						<h1><?php esc_html_e( 'Popy', 'popy-popup' ); ?></h1>
						<p><?php esc_html_e( 'Timed Popups That Respect Your Visitors', 'popy-popup' ); ?></p>
					</div>
					<div class="popy-header-version">
						<?php /* translators: %s: plugin version number */ ?>
						<span><?php printf( esc_html__( 'v%s', 'popy-popup' ), esc_html( POPY_VERSION ) ); ?></span>
					</div>
				</div>
			</div>
			...
			<div class="popy-layout">
				...
				<div class="popy-form-col">
					<form method="post" action="options.php" id="popyForm">
						...
						<!-- BEHAVIOUR -->
						<div class="popy-card">
							<h2><?php esc_html_e( '⚙️ Behaviour', 'popy-popup' ); ?></h2>

							<div class="popy-row popy-toggle-row">
								<label for="popy_enabled"><?php esc_html_e( 'Enable Popup', 'popy-popup' ); ?></label>
							...
							<div class="popy-row">
								<label for="popy_delay"><?php esc_html_e( 'Delay before showing', 'popy-popup' ); ?> <small><?php esc_html_e( '(seconds)', 'popy-popup' ); ?></small></label>
							...
							<div class="popy-row">
								<label for="popy_cookie_days"><?php esc_html_e( 'Cookie lifetime', 'popy-popup' ); ?> <small><?php esc_html_e( '(days — 0 = show every visit)', 'popy-popup' ); ?></small></label>
							...
							<div class="popy-row popy-toggle-row">
								<label for="popy_overlay_close"><?php esc_html_e( 'Close when clicking overlay', 'popy-popup' ); ?></label>
								<label class="popy-switch">
						...
						<!-- CONTENT -->
						<div class="popy-card">
							<h2><?php esc_html_e( '✏️ Content', 'popy-popup' ); ?></h2>

							<div class="popy-row">
								<label for="popyIcon"><?php esc_html_e( 'Icon / Emoji', 'popy-popup' ); ?></label>
							...
							<div class="popy-row">
								<label for="popyEyebrow"><?php esc_html_e( 'Eyebrow', 'popy-popup' ); ?> <small><?php esc_html_e( '(small text above title)', 'popy-popup' ); ?></small></label>
							...
							<div class="popy-row">
								<label for="popyTitle"><?php esc_html_e( 'Title', 'popy-popup' ); ?></label>
							...
							<div class="popy-row">
								<label for="popySubtitle"><?php esc_html_e( 'Subtitle', 'popy-popup' ); ?> <small><?php esc_html_e( '(HTML: <strong>, <em> allowed)', 'popy-popup' ); ?></small></label>
							...
							<div class="popy-row">
								<label for="popyBody"><?php esc_html_e( 'Body line', 'popy-popup' ); ?> <small><?php esc_html_e( '(HTML: <strong>, <em> allowed)', 'popy-popup' ); ?></small></label>
							...
							<div class="popy-row">
								<label for="popyFootnote"><?php esc_html_e( 'Footnote', 'popy-popup' ); ?> <small><?php esc_html_e( '(bottom small text)', 'popy-popup' ); ?></small></label>
						...
						<!-- BUTTONS -->
						<div class="popy-card">
							<h2><?php esc_html_e( '🔘 Buttons', 'popy-popup' ); ?></h2>

							<div class="popy-row">
								<label for="popyPrimaryText"><?php esc_html_e( 'Primary button text', 'popy-popup' ); ?></label>
							...
							<div class="popy-row">
								<label for="popyPrimaryUrl"><?php esc_html_e( 'Primary button URL', 'popy-popup' ); ?> <small><?php esc_html_e( '(mailto: and tel: supported)', 'popy-popup' ); ?></small></label>
							...
							<div class="popy-row">
								<label for="popySecondaryText"><?php esc_html_e( 'Secondary button text', 'popy-popup' ); ?></label>
							...
							<div class="popy-row">
								<label for="popySecondaryUrl"><?php esc_html_e( 'Secondary button URL', 'popy-popup' ); ?></label>
							...
							<div class="popy-row popy-toggle-row">
								<label for="popy_show_dismiss"><?php esc_html_e( 'Show dismiss link', 'popy-popup' ); ?></label>
								<label class="popy-switch">
							...
							<div class="popy-row">
								<label for="popyDismissText"><?php esc_html_e( 'Dismiss link text', 'popy-popup' ); ?></label>
						...
						<!-- APPEARANCE -->
						<div class="popy-card">
							<h2><?php esc_html_e( '🎨 Appearance', 'popy-popup' ); ?></h2>
							<div class="popy-row">
								<label for="popyAccent"><?php esc_html_e( 'Accent colour', 'popy-popup' ); ?> <small><?php esc_html_e( '(primary button + eyebrow)', 'popy-popup' ); ?></small></label>
						...
						<?php submit_button( __( 'Save Changes', 'popy-popup' ), 'primary popy-save' ); ?>
					</form>
				</div>
				...
				<div class="popy-preview-col">
					<div class="popy-card popy-preview-card">
						<h2><?php esc_html_e( '👁 Live Preview', 'popy-popup' ); ?></h2>
						...
						<div class="popy-reset-wrap">
							<button type="button" id="popyResetCookie" class="button">
								<?php esc_html_e( '🔄 Reset cookie (re-test popup)', 'popy-popup' ); ?>
							</button>
							<p><?php esc_html_e( 'Clears the dismissed cookie on this browser so the popup appears again on your next visit.', 'popy-popup' ); ?></p>
						</div>
					</div>
				</div>
